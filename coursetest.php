...
<head>
	<title>Learn2Win | 「學習任務」校本測驗及實用練習</title>
	<meta charset="utf-8" />
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span9">
							<h1 class="page-title">「學習任務」﹣小五﹣閱讀理解(1)</h1>
							<iframe name='proprofs' id='proprofs' width='90%' height='600%' frameborder=0 marginwidth=0 marginheight=0 src='http://www.proprofs.com/quiz-school/story.php?title=p5-comprehension-2-listen-to-naju-listening-class&id=482063&ew=630'></iframe>
						</div>
						...
						<div class="span3">
							<div id="sidebar" class="sidebar-right">
								...
								<div class="widget">
									...
									<ul class="menu">
										<li><a href="coursetest.php">課程一 :小五﹣閱讀理解(1)</a></li>
										<li><a href="coursetest1.php">課程二 :小五﹣閱讀理解(2)</a></li>
										<li><a href="coursetest2.php">課程三 :小五﹣英文文法(1)</a></li>	
										<li><a href="coursetest3.php">課程四 :小五﹣英文文法(2)</a></li>		
										<li><a href="coursetest4.php">課程四 :小五﹣英文詞彙(1)</a></li>		
									</ul><!-- end footer menu -->
								</div><!-- end widget -->
							</div>
						</div>
