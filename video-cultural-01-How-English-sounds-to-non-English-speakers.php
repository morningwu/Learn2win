					...
					<div class="row">
						...
						<div class="span2">
							<div id="sidebar" class="sidebar-left">
								...
								<div class="widget">
									<h4 class="title">其他文化影片</h4>
									<ul class="menu">
									
									<li><a href="video-cultural-01-How-English-sounds-to-non-English-speakers.php">Miscommunication</a></li>
									<li><a href="#">其他影片01</a></li>
									<li><a href="#">其他影片02</a></li>
									<li><a href="#">其他影片03</a></li>
									<li><a href="#">其他影片04</a></li>
									<li><a href="#">其他影片05</a></li>
									<li><a href="#">其他影片06</a></li>
									<li><a href="#">其他影片07</a></li>
									<li><a href="#">其他影片08</a></li>
									<li><a href="#">其他影片09</a></li>
									<li><a href="#">其他影片10</a></li>
										
										
									</ul><!-- end footer menu -->
									<a href="video-new.php"><button type="button" class="btn btn-danger">影片目錄</button></a>
								</div><!-- end widget -->
								<!--
								<div class="widget">
						...
						<div class="span7">
							...
							<h1 class="page-title">文化教學 - Miscommunication in English</h1>

							<div class="span7">
								<iframe width="600" height="400" src="http://www.youtube.com/embed/Vt4Dfa4fOEY?rel=0" frameborder="0" allowfullscreen></iframe>
							</div>
							...
							<div class="span7">
								<div class="tabbable tabs_style1">
								  <ul class="nav fixclear">
								  	<li class="active"><a href="#tabs1-pane1" data-toggle="tab">影片簡介</a></li>
								    <li><a href="#tabs1-pane2" data-toggle="tab">學習重點</a></li>
								    <li><a href="#tabs1-pane3" data-toggle="tab">學習任務</a></li>
								  ...
								  <div class="tab-content">
								      ...
								      <div class="tab-pane active" id="tabs1-pane2">
								        ...
								        <p>學習重點</p>
								        <ul>
								        	<li>Sunny-side-up ：太陽旦</li>
								        	<li>Boiled Egg：水煮旦</li>
								        	<li>Scrambled Egg：炒旦</li>
								        	<li>Let's go Dutch!：平分帳目</li>
								        	<li>Check the bill：埋單</li>
								        </ul>
								      </div>
								      <div class="tab-pane" id="tabs1-pane3">
								        <iframe name='proprofs' id='proprofs' width='580' height='400' frameborder=0 marginwidth=0 marginheight=0 src='http://www.proprofs.com/quiz-school/story.php?title=_444710&id=452208&ew=530'></iframe>
								      </div>
