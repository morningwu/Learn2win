				...
				<div id="mainbody">
					...
					<div class="row">
						...
						<div class="thank-you-container">
							<h1><span class="font-orange">Sorry!</span></h1>
							<div class="divide50"></div>
							<p class="big-font">你必須登入方可探訪此頁</p>
							<div class="divide50"></div>
							<p><a href="login-educator.php" class="btn btn-success">登入</a>
							<a href="register-educator.php" class="btn btn-danger">沒有帳戶?</a></p>
						</div>
