				...
				<div class="row">
					...
					<div class="span6">
						<div class="header-titles">
							<h2>「系統教學」(4)</h2>
							<h4>Word Order - Sentence Structure  </h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span9">
							<h1 class="page-title">「系統教學」課程影片:Word Order - Sentence Structure </h1>
							<iframe width="90%" height="600%" src="http://www.youtube.com/embed/VPyo8-Pr55Q?list=PLBE473957FDF66B70" frameborder="0" allowfullscreen></iframe>
