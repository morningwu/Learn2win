...
<? include('function/database/connect.php'); ?>
			...
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						...
						<div class="span12">
							<h1 class="page-title">註冊/登入</h1>
							<div class="tabbable tabs_style1">
							  <ul class="nav fixclear">
							    <li class="active"><a href="#tabs1-pane1" data-toggle="tab">登入</a></li>
							    <li><a href="#tabs1-pane2" data-toggle="tab">註冊</a></li>
							  ...
							  <div class="tab-content">
							      <div class="tab-pane active" id="tabs1-pane1">
							       ...
							       <form class="form-horizontal" name="logn" action="" method="POST"/>
		            					<div class="control-group">
		              						<label class="control-label" for="inputEmail">登入電郵</label>
		              					<div class="controls">
		                				<input type="text" name="email" placeholder="Email" />
		              					</div>
		            					</div>
							            <div class="control-group">
							              <label class="control-label" for="inputPassword">登入密碼</label>
							              <div class="controls">
							            ...
							            <div class="control-group">
							              <div class="controls">
							               <a href="account.php" class="btn btn-success">登入</a>
							      ...
							      <div class="tab-pane" id="tabs1-pane2">
							      	...
							      	if(isset($_POST['email']) && isset($_POST['password']) == true){
							      		...
							      		/*echo "You should enter your login email and password!";
							      	}
...
*/
							        ...
							        <form class="form-horizontal" name="register" action="" method="POST" />
		            					<div class="control-group">
		              						<label class="control-label" for="inputEmail">登入名稱</label>
		              					<div class="controls">
		                				<input type="text" name="email" placeholder="Email" />
		              					</div>
		            					</div>
							            ...
							            <div class="control-group">
							              <label class="control-label" for="inputPassword">重新輸入密碼</label>
							              <div class="controls">
							            ...
							            <div class="control-group">
							              <div class="controls">
							               <input type="submit" class="btn btn-danger" value="註冊">
