...
if(isset($_POST['email'],$_POST['password'])){
  ...
  if(check_user_student($_POST['email'],$_POST['password']) === false){
  ...
  if(empty($errors)){
  	...
  	$mysql_set_login_name = mysql_query("SELECT `student_name` FROM `users` WHERE `email` = '$student_email'");
  	
  	$set_login_name = mysql_fetch_array($mysql_set_login_name);
  	
  	$_SESSION['student_name'] = htmlentities($set_login_name[0]);
			...
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						...
						<div class="span12">
							<h1 class="page-title">Student Account(Login)</h1>
							<div class="font-orange">
								<?php
							        ...
							        <form name ="educator-form-register" action ="" class="form-horizontal"  method="POST"/>
							            ...
							            <div class="control-group">
							              <div class="controls">
							               <input type="submit" class="btn btn-success" value="Login"> <a href="register-student.php">Need An account?</a>
							              </div>
							            </div>
					          		</form>
						</div>
