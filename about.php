		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span12">
							<h1 class="page-title">教學理念</h1>
							
							<p><strong>開放教學平台</strong>：</p>
							<p><strong>學生學習社群</strong>：</p>
						...
						<div class="acc-group default-style">
							<button data-toggle="collapse" data-target="#acc1" class="collapsed">1. Gamification in Education</button>
							<div id="acc1" class="collapse in">
								<div class="content">
									<p>Gamification in has been talking a decade in business and now entered the world of education/</p>
								</div><!-- end content -->
							</div>
						</div><!-- end acc group -->
						<div class="acc-group default-style">
							<button data-toggle="collapse" data-target="#acc1" class="collapsed">2. Gamification in Education</button>
							<div id="acc1" class="collapse in">
								<div class="content">
									<p>Gamification in has been talking a decade in business and now entered the world of education/</p>
								</div><!-- end content -->
						...
						<div class="acc-group default-style">
							<button data-toggle="collapse" data-target="#acc1" class="collapsed">3. Gamification in Education</button>
							<div id="acc1" class="collapse in">
								<div class="content">
									<p>Gamification in has been talking a decade in business and now entered the world of education/</p>
								</div><!-- end content -->
						...
						<div class="acc-group default-style">
							<button data-toggle="collapse" data-target="#acc1" class="collapsed">4. Gamification in Education</button>
							<div id="acc1" class="collapse in">
								<div class="content">
									<p>Gamification in has been talking a decade in business and now entered the world of education/</p>
								</div><!-- end content -->
							...
							<div class="row">
									...
									<div class="team_member">
										...
										<div class="details">
											<div class="desc">
												...
												<p>Email: morningwu@learn2win.com.hk<br />
								...
								<div class="span3">
									<div class="team_member">
										...
										<h4>K.M. Yim</h4>
										<h6>Co-Founder , Chairman</h6>
										<div class="details">
											<div class="desc">
												<p>xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
												<p>Email: kmyim@learn2win.com.hk<br />
												Phone: 44 555 33 66</p>
											</div>
											<ul class="social-icons colored fixclear">
												<!--<li class="social-twitter"><a href="#">Twitter</a></li>-->
					...
					<div class="row">
						...
						<div class="span4">
							<a href="images/team/office/office1.jpg" class="hoverBorder" rel="prettyPhoto"><img src="images/team/office/office1.jpg" alt="" /></a>
						</div>
						<div class="span4">
							<a href="images/team/office/office2.jpg" class="hoverBorder" rel="prettyPhoto"><img src="images/team/office/office2.jpg" alt="" /></a>
						</div>
						<div class="span4">
							<a href="images/team/office/office3.jpg" class="hoverBorder" rel="prettyPhoto"><img src="images/team/office/office3.jpg" alt="" /></a>
						</div>
					</div>
					-->
				</div><!-- end mainbody -->
