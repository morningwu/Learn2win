			...
			<div class="container">
				...
				<div id="mainbody">
					<div class="row">
						...
						<div class="span12" >
							<div class="img-intro text-center-align"></div>
						</div>

						<div class="span 12">
							<h1 class="page-title">教學模式</h1>
							<!-- Step 1-->
								<div class="span3">
									<div class="img-intro text-center-align"><img src="images/portfolio_images/icon-07.png" width="150px" height="150px"/></div>
								</div>
								<div class="span5">
									<h3 class="title">Step 1：入學評估</h3>
									<div class="pt-cat-desc">
										<p>照顧學生學習差異，每位註冊學生必須經過學習評估，再分派至不同學習等級。不同等級將分派不同難道練習、學生曾曾遞進學習難度</p>
									</div><!-- pt cat desc -->
								</div>
								<div class="span2">
									<img src="images/character/char1.png">
								</div>
								...
								<!-- Step 2-->
								<div class="span3">
									<div class="img-intro text-center-align"><img src="images/portfolio_images/icon-12.png" width="150px" height="150px"/></div>
								</div>
								<div class="span5">
									<h3 class="title">Step 2：教學影片</h3>
									<div class="pt-cat-desc">
										<p>每天觀看教學影片、主題包括：生活化教學、系統化教學及文化教學。每段影片約10﹣15分鐘，以校本教學內容為基礎設計。每天只需喝一杯咖啡的時間、輕鬆學習</p>
									</div><!-- pt cat desc -->
								</div>
								<div class="span2">
									<img src="images/character/char2.png">
								</div>
								...
								<!-- Step 3-->
								<div class="span3">
									<div class="img-intro text-center-align"><img src="images/portfolio_images/icon-13.png" width="150px" height="150px"/></div>
								</div>
								<div class="span5">
									<h3 class="title">Step 3：學習任務</h3>
									<div class="pt-cat-desc">
										<p>每段學習影片將伴隨一個「學習任務」、包括校本設計之練習、互動口語練習、實時翻譯等、加強學生學習記憶</p>
									</div><!-- pt cat desc -->
								</div>
								<div class="span2">
									<img src="images/character/char4.png">
								</div>
								...
								<div class="span3">
									<div class="img-intro text-center-align"><img src="images/portfolio_images/icon-15.png" width="150px" height="150px"/></div>
								</div>
								<div class="span5">
									<h3 class="title">Step 4：我有問題？</h3>
									<div class="pt-cat-desc">
										<p>可直接與老師對答，或以短訊發問</p>
									</div><!-- pt cat desc -->
								</div>
								<div class="span2">
									<img src="images/character/char5.png">
								</div>
								<div class="span12">
									<hr class="bs-docs-separator" />
								</div>
								...
								<!-- Step 4-->
								<div class="span3">
									<div class="img-intro text-center-align"><img src="images/portfolio_images/icon-04.png" width="150px" height="150px"/></div>
								</div>
								<div class="span5">
									<h3 class="title">Step 5：學習報告</h3>
									<div class="pt-cat-desc">
										<p>每週家長及學生將收到學生學習報告，記錄平台用量、獲得之學習點及成績之進、退步</p>
									</div><!-- pt cat desc -->
								</div>
								<div class="span2">
									<img src="images/character/char6.png">
								</div>
								...
								<!-- Step 5-->
								<div class="span3">
									<div class="img-intro text-center-align"><img src="images/portfolio_images/icon-14.png" width="150px" height="150px"/></div>
								</div>
								<div class="span5">
									<h3 class="title">Step 6：分享受益</h3>
									<div class="pt-cat-desc">
										<p>以完成學習任務獲取「學習點」、可兌換禮物或捐款現金、立刻分享所學受益</p>
									</div><!-- pt cat desc -->
								</div>
								<div class="span2">
									<img src="images/character/char7.png">
								</div>
							...
							<div class="acc-group style2">
								...
								<a href="video-new.php" class="circlehover with-symbol" data-align="center">
									<span class="text">Learn2win示範影片</span>
