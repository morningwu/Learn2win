				...
				<div class="row">
					...
					<div class="span6">
						<div class="header-titles">
							<h2>「系統教學」(10)</h2>
							<h4>English Writing - Sequencing</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span9">
							<h1 class="page-title">「系統教學」課程影片:English Writing - Sequencing </h1>
							<iframe width="90%" height="600%" src="http://www.youtube.com/embed/-HutuMqTAPw?list=UUgzuT-fpJiyThTUlMiFRCKQ" frameborder="0" allowfullscreen></iframe>
						</div>
