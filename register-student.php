...
include ('info.php'); 
include ('function/user/registration.php'); 
			...
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						...
						<div class="span12">
							<h1 class="page-title">Student Account(Register)</h1>
							        	...
							        	if(isset($_POST['email'], $_POST['password'],$_POST['password_cfm'])){
							        		...
							        		if(empty($_POST['email'])){
											  ...
											  if($_POST['password'] !== $_POST['password_cfm']){
											   ...
											   if(user_exist_student($_POST['email'])){
												    $errors[] = "登入電郵已註冊";
											  }
											  if(empty($errors)){
											    ...
											    $_SESSION['student_name'] 			= htmlentities($_POST['student_name']);
    											$_SESSION['user_id']   				= mysql_query("SELECT `user_id` FROM `user` WHERE `email` = 'email'");
							        ...
							        <form name ="user-form-register" action ="" class="form-horizontal"  method="POST"/>
		            					...
		            					<div class="control-group">
			              					...
			              					<div class="controls">
			                					<input type="text" name ="student_name"  value="<?php if(isset($_POST['student_name'])){echo $_POST['student_name'];} ?>"/>
			              					</div>
		            					</div>
		            					<div class="control-group">
		              						<label class="control-label" >Student age：</label>
			              					<div class="controls">
			                					<input type="text" name ="student_age"  value="<?php if(isset($_POST['student_age'])){echo $_POST['student_age'];} ?>"/>
			              					</div>
		            					</div>
		            					<div class="control-group">
		              						<label class="control-label" >School：</label>
			              					<div class="controls">
			                					<input type="text" name ="student_school"  value="<?php if(isset($_POST['student_school'])){echo $_POST['student_school'];} ?>"/>
			              					</div>
		            					</div>
		            					<div class="control-group">
		              						<label class="control-label" >Level：</label>
			              					<div class="controls">
			                					<input type="text" name ="student_level"  value="<?php if(isset($_POST['student_level'])){echo $_POST['student_level'];} ?>"/>
			              					</div>
		            					</div>
