...
<head>
	<title>Learn2Win | 「外國文化」課程影片</title>
	<meta charset="utf-8" />
				...
				<div class="row">
					...
					<div class="span6">
						<div class="header-titles">
							<h2>「外國文化」課程影片</h2>
							<h4>Talk like a native speaker</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span9">
							<h1 class="page-title">「外國文化」課程影片:Talk like a native speaker - GONNA, HAVETA, WANNA</h1>
							<iframe width="90%" height="600%" src="http://www.youtube.com/embed/IJPdR7Kbl9k?list=PL843FD509785C02A8" frameborder="0" allowfullscreen></iframe>
						</div>
						...
						<div class="span3">
							<div id="sidebar" class="sidebar-right">
								...
								<div class="widget">
									...
									<ul class="menu">
										<li><a href="coursecult.php">課程一 :街頭英語文化(1)</a></li>
										<li><a href="coursecult1.php">課程二 :住倫敦住到破產</a></li>
										<li><a href="coursecult2.php">課程三 :Interviewing Native Speaker in London(1)</a></li>
										<li><a href="coursecult3.php">課程四 :Interviewing Native Speaker in London(2)</a></li>
										<li><a href="coursecult4.php">課程五 :Take like a native speaker</a></li>					
									</ul><!-- end footer menu -->
								</div><!-- end widget -->
							</div>
						</div>
