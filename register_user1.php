			...
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						...
						<div class="span12">
							<h1 class="page-title">註冊（Step2）</h1>   
						</div>
						...
						<div class="span12">
							...
							<form class="form-horizontal" />
		            					<div class="control-group">
		              						<label class="control-label" for="inputEmail">家長姓名</label>
		              					<div class="controls">
							            ...
							            <div class="control-group">
							              <label class="control-label" for="inputPassword">聯絡電郵</label>
							              <div class="controls">
							                <input type="text" name="email" />
							              </div>
							            </div>
							            <div class="control-group">
							              <label class="control-label" for="inputPassword">聯絡地址</label>
							              <div class="controls">
							                <input type="text" name="email" />
							              </div>
							            </div>
							             ...
							             <div class="control-group">
							              <label class="control-label" for="inputPassword">學生姓名</label>
							              <div class="controls">
							                <input type="text" name="student_name" />
							              </div>
							            </div>
							            <div class="control-group">
							              <label class="control-label" for="inputPassword">學生年級</label>
							              <div class="controls">
							                <input type="text" name="student_level" />
							              </div>
							            </div>
							            <div class="control-group">
							              <label class="control-label" for="inputPassword">就讀學校</label>
							              <div class="controls">
							                <input type="text" name="student_level" />
							              </div>
							            </div>
							            <div class="control-group">
							              <label class="control-label" for="inputPassword">出生日期</label>
							              <div class="controls">
							                <input type="text" name="student_level" />
							              </div>
							            </div>
							            <div class="control-group">
							              <div class="controls">
							               ...
							               <a href="thanks.php" class="btn btn-danger">註冊</a>
							              </div>
							            </div>
					          		</form>
						</div>
