						...
						<div class="span2">
							<div id="sidebar" class="sidebar-left">
								...
								<div class="widget">
									...
									<ul class="menu">
										<li><a href="video-new.php"><span class="font_orange">今日學咩</span></a></li>
										<li><a href="video-live-english.php">生活化影片</a></li>
										<li><a href="video-systematic.php">系統化影片</a></li>
										<li><a href="video-cultural.php">文化教學影片</a></li>
										<li><a href="video-3minutes-english.php">三分鐘速學影片</a></li>
										<li><a href="video-special.php">特別教學影片</a></li>
										<li><a href="video-revision.php">重溫學習重點</a></li>
						...
						<div class="span10">
							...
							<h1 class="page-title">影片重溫</h1>
								...
								<div class="span3 box">
									...
									<div class="details">
										<h4>文化教學 - 10 Attraction in London</h4>
										<p>What made London so Attractive?</p>
									</div>
									</a>
