				...
				<div id="mainbody">
					...
					<div class="row">
						...
						<div class="span3">
							<div id="sidebar" class="sidebar-left">
								...
								<div class="widget">
									...
									<ul class="menu">
										<li class="active"><a href="#">試用課程</a></li>
						...
						<div class="span9">
							...
							<h1 class="page-title">試用課程</h1>

							<div class="tabbable tabs_style1">
								  <ul class="nav fixclear">
								    <li class="active"><a href="#tabs1-pane1" data-toggle="tab">Day 1</a></li>
								    <li><a href="#tabs1-pane2" data-toggle="tab">Day 2</a></li>
								    <li><a href="#tabs1-pane3" data-toggle="tab">Day 3</a></li>
								    <li><a href="#tabs1-pane4" data-toggle="tab">Day 4</a></li>
								     <li><a href="#tabs1-pane5" data-toggle="tab">Day 5</a></li>
								  </ul>
								  <div class="tab-content">
								      <div class="tab-pane active" id="tabs1-pane1">
								      	<div class="span6">
								      		<h4 class="page-title">Class 1</h4>
								      	</div>
								      		<div class="span3 box ">
								      ...
								      <div class="tab-pane" id="tabs1-pane2">
								      	<div class="span6">
								      		<h4 class="page-title">Class 3</h4>
								      	</div>
								      	<div class="span3 box">
											<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
										...
										<div class="span2">
											...
											<h4>海外生活/文化影片Lost in Cultural Learning</h4>
											<p>Why English is so wired to Non English Speaker?</p>
											<a href="video-live-english-01-restaurant-english.php"><button type="button" class="btn btn-success">立即睇片</button></a>
										</div>
								      ...
								      <div class="tab-pane" id="tabs1-pane3">
								      	<div class="span6">
								      		<h4 class="page-title">Class 4</h4>
								      	</div>
								      	<div class="span3 box">
											<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
												<img src="images/portfolio_images/course-icon2.png" width="350px" height="225px"/>
								    ...
								    <div class="span2">
								      ...
								      <div class="tab-pane" id="tabs1-pane4">
								      	<div class="span6">
								      		<h4 class="page-title">Class 5</h4>
								      	</div>
								      	<div class="span3 box">
											<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
								      ...
								      <div class="tab-pane" id="tabs1-pane5">
								      	<div class="span6">
								      		<h4 class="page-title">Class 6</h4>
								      	</div>
								      	<div class="span3 box">
											<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
