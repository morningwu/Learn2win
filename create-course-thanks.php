					...
					<div class="row">
						<div class="span12">
							...
							<div class="thank-you-container">
								<h1><span class="font-orange">Thank You!<?php if(isset($_SESSION['name'])){echo $_SESSION['name'];} ?></span></h1>
								<div class="divide50"></div>
								<p class="big-font2">We will review your uploaded content and contact you soon</p>
								<div class="divide50"></div>
								<p><a href="destory_title.php" class="btn btn-success">Create More Content</a></p>
							</div>
