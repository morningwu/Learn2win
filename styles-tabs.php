...
&lt;/div&gt;
	...
	<div class="tabbable tabs_style2">
		<ul class="nav fixclear">
			<li class="active"><a href="#tabs2-pane1" data-toggle="tab">Some Tab #1</a></li>
			<li><a href="#tabs2-pane2" data-toggle="tab">Some Tab #2</a></li>
			<li><a href="#tabs2-pane3" data-toggle="tab">Some Tab #3</a></li>
		</ul>
		<div class="tab-content">
	...
	<div class="tabbable tabs_style3">
		<ul class="nav fixclear">
			<li class="active"><a href="#tabs3-pane1" data-toggle="tab">Some Tab #1</a></li>
			<li><a href="#tabs3-pane2" data-toggle="tab">Some Tab #2</a></li>
			<li><a href="#tabs3-pane3" data-toggle="tab">Some Tab #3</a></li>
		</ul>
		<div class="tab-content">
	...
	<div class="tabbable tabs_style4">
		<ul class="nav fixclear">
			<li class="active"><a href="#tabs4-pane1" data-toggle="tab">Some Tab #1</a></li>
			<li><a href="#tabs4-pane2" data-toggle="tab">Some Tab #2</a></li>
			<li><a href="#tabs4-pane3" data-toggle="tab">Some Tab #3</a></li>
		</ul>
		<div class="tab-content">
