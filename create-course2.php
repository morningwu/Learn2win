					...
					<div class="row">
						...
						<div class="span9">
							...
							<ul class="course-step-list">
								...
								<li><a href="create-course2.php" id="active">Step 2：Upload Video &raquo;</a></li>
							...
							<hr/>
								<div id="inner-container">
									<h5 class="page-title">Upload Your Video</h5>
									

									<p>Please Upload your video to <a href="http://www.youtube.com">Youtube</a> and provide us the link:</p>

									<?php

										if(isset($_POST['video-link'])){
											if(empty($_POST['video-link'])){
												$errors[] = "You must enter your a link!";
											}
											if(empty($errors)){

												$video_link         	= $_POST['video-link'];
												
											    Insert_class_content_link($video_link);
											}
										}
									?>
										...
										<h5><?php if(isset($_SESSION['class-title'])){echo "You are Creating the Topic : ".$_SESSION['class-title'];} ?></h5>
								      	...
								      	<form name ="video-upload"  action="" method="POST">

								      		Youtube Link：
								      		<input name="video-link" type="text">

								      		<!--<p><a href="create-course3.php" class="btn btn-warning">Next</a></p>-->
