					...
					<div class="row">
						...
						<div class="span2">
							<div id="sidebar" class="sidebar-left">
								...
								<div class="widget">
									<h4 class="title">學習影片列表</h4>
									<ul class="menu">
										<li><a href="video-new.php"><span class="font_orange">示範影片</span></a></li>
										<!--<li><a href="video-live-english.php">本地生活影片</a></li>
										<li><a href="video-systematic.php">系統化教學</a></li>
										<li><a href="video-cultural.php">海外生活/文化影片</a></li>
										<li><a href="video-3minutes-english.php">睇電影、學英語</a></li>
										<li><a href="video-special.php">What's Going Wrong?</a></li>
										<li><a href="video-revision.php">Writing and Comprehension</a></li>
							...
							<img src="images/character/char9.png">
							<div class="divide20"></div>
							<img src="images/character/char10.png">
						-->
						</div>
					
						<div class="span10">
							
							<h1 class="page-title">示範影片</h1>

								<div class="span3 box ">
									<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
										<img src="images/portfolio_images/course-icon1.png" width="350px" height="225px"/>
									<div class="details">
										<h3><span class="font-orange">本地生活影片</span></h3>
										<h5>Slice-of-Life English Video</h5>
										<p>係餐廳點叫野食？</p>
									</div>
									</a>
									<h3><span class="font-orange">本地生活影片</span></h3>
									<h5>Slice-of-Life English Video</h5>
									<p>日常英語應用，即學即用</p>
									<a href="video-live-english-01-restaurant-english.php"><button type="button" class="btn btn-success ">立即睇片</button></a>
								</div>

								<div class="span3 box">
									<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
										<img src="images/portfolio_images/course-icon3.png" width="350px" height="225px"/>
									<div class="details">
										<h3><span class="font-orange">海外生活影片</span></h3>
										<h5>Learning Overseas English</h5>
										<p>Why English is so wired to Non-English Speaker?</p>
									</div>
									</a>
                   					<h3><span class="font-orange">海外生活影片</span></h3>
									<h5>Learning Overseas English</h5>
									<p>認識海外英語，Think like an American</p>
									<a href="video-live-english-01-restaurant-english.php"><button type="button" class="btn btn-success">立即睇片</button></a>
								</div>

								<div class="span3 box">
									<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
										<img src="images/portfolio_images/course-icon6.png" width="350px" height="225px"/>
									<div class="details">
										<h3><span class="font-orange">電影、動漫、新聞英語</span></h3>
										<h5>Movie,Animate and News English</h5>
										<p>Learning English From Animation,News and Movie</p>
									</div>
									</a>
									<h3><span class="font-orange">電影、動漫、新聞英語</span></h3>
									<h5>Movie,Animate and News English</h5>
								...
								<div class="span3 box">
									<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
										<img src="images/portfolio_images/course-icon2.png" width="350px" height="225px"/>
									<div class="details">
										<h3><span class="font-orange">英語文法教學</span></h3>
										<h5>Explanatory English Grammar Workshop</h5>
										<p>Basic Nonu,Verbs,Adjective and Adverb</p>
									</div>
									</a>
									<h3><span class="font-orange">英語文法教學</span></h3>
									<h5>Explanatory Grammar Workshop</h5>
									<p>認識更多Nonu,Verbs,Adjective and Adverb</p>
									<a href="video-live-english-01-restaurant-english.php"><button type="button" class="btn btn-warning">立即睇片</button></a>
                   				</div>

                   				<div class="span3 box">
									<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
										<img src="images/portfolio_images/course-icon4.png" width="350px" height="225px"/>
									<div class="details">
										<h3><span class="font-orange">英語寫作閱讀</span></h3>
										<h5>Wrinting and Comprehension</h5>
										<p>Basic Nonu,Verbs,Adjective and Adverb</p>
									</div>
									</a>
									<h3><span class="font-orange">英語寫作閱讀</span></h3>
                   				...
                   				<div class="span3 box">
									<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
										<img src="images/portfolio_images/course-icon5.png" width="350px" height="225px"/>
									<div class="details">
										<h3><span class="font-orange">港式英語診療</span></h3>
										<h5>Chinglish Clinic</h5>
										<p>Basic Nonu,Verbs,Adjective and Adverb</p>
									</div>
									</a>
									<h3><span class="font-orange">港式英語診療</span></h3>
                   				...
                   				<div class="span3 box">
									<a href="video-live-english-01-restaurant-english.php" class="slidingDetails">
										<img src="images/portfolio_images/course-icon7.png" width="350px" height="225px"/>
									<div class="details">
									<h3><span class="font-orange">考試技巧工作坊</span></h3>
										<h5>Examination Tips Workshop</h5>
										<p>Basic Nonu,Verbs,Adjective and Adverb</p>
									</div>
									</a>
									<h3><span class="font-orange">考試技巧工作坊</span></h3>
								...
								<!--<div class="span3 box">
									<a href="#" class="slidingDetails">
										<img src="images/portfolio_images/course-icon4.png" width="350px" height="225px"/>
									<div class="details">
										<h4>三分鐘速學 - Word of the Day</h4>
										<p>了解Wonderful,Amazing,Fantactic </p>
									</div>
									</a>
									<h4>三分鐘速學 - Word of the Day</h4>
									<p>Using compliment words</p>
									<a href="#"><button type="button" class="btn btn-success">立即睇片</button></a>
                   				</div>-->
								<!--<div class="span3 box">
									<a href="#" class="slidingDetails">
										<img src="images/portfolio_images/course-icon5.png" width="350px" height="225px"/>
									<div class="details">
										<h4>特別教學影片 - Learning from Errors</h4>
										<p>Whats' wrong with these sentence?</p>
									</div>
									</a>
									<h4>特別教學影片 - Learning from Errors</h4>
									<p>Whats' wrong with these sentence?</p>
