					...
					<div class="row">
						...
						<div class="span9">
							...
							<ul class="course-step-list">
								...
								<li><a href="create-course4.php" id="active">Step 4：Study Mission &raquo;</a></li>
								<li><a href="create-course5.php">Step 5：Confirm</a></li>
							</ul>
							<hr/>
								<div id="inner-container">
									<h5 class="page-title">Create Learning Mission</h5>
									...
									<p>Create Your Learning Flash Card：</p>
								      	...
								      	<form name ="flash-card"  action="" method="POST">
								      		...
								      		<h5>Learning Mission(Fill in the Blanks)</h5>
								      		<ol>
								      			<li>
								      				<input type="text" name = "Learning_Mission_Question_1" value="" placeholder="Question">
								      				<input type="text" name = "Learning_Mission_Answer_1" value="" placeholder="Answer">
								      			</li>
								      			<li>
								      				<input type="text" name = "Learning_Mission_Question_2" value="" placeholder="Question">
								      				<input type="text" name = "Learning_Mission_Answer_2" value="" placeholder="Answer">
								      			</li>
								      			<li>
								      				<input type="text" name = "Learning_Mission_Question_3" value="" placeholder="Question">
								      				<input type="text" name = "Learning_Mission_Answer_3" value="" placeholder="Answer">
								      			</li>
								      			<li>
								      				<input type="text" name = "Learning_Mission_Question_4" value="" placeholder="Question">
								      				<input type="text" name = "Learning_Mission_Answer_4" value="" placeholder="Answer">
								      			</li>
								      			<li>
								      				<input type="text" name = "Learning_Mission_Question_5" value="" placeholder="Question">
								      				<input type="text" name = "Learning_Mission_Answer_5" value="" placeholder="Answer">
								      			</li>

								      		</ol>
								      		<p>
								      			<a href="#" class="btn btn-success">Add</a>
								      			<a href="#mission_tips" data-rel="prettyPhoto[login_panel]" class="btn btn-danger">Tips</a>
								      			
								      			<a href="create-course5.php" class="btn btn-warning">Next</a>
								      			<?php include('mission_tips.php');?>
								      		</p>
								      		<!--<p><input type="submit" value="next" class="btn btn-warning"></p>-->
								      	</form>

								      	<p>For Other format, please <a href="mailto:admin@learn2win.com.hk">contact us</a></p>
								</div>
