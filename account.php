				...
				<div id="mainbody">
					...
					<div class="row">
						...
						<div class="span12">
							...
							<h1 class="page-title">Hello ! <? if(isset($_SESSION['student_name'])){echo $_SESSION['student_name']; }?></h1>
							<div class="row image-boxes imgboxes_style1">
			                    <div class="span4 box">
									<a href="video-new.php" class="hoverBorder">
										<img src="images/site_images/img-01.png" alt="">
									
									</a>
			                        <h3 class="m_title">最新課程</h3>
			                        <p><a href="video-new.php" class="btn btn-success">即睇</a></p>
								...
								<div class="span4 box">
			                        ...
			                        <h3 class="m_title">課程重溫</h3>
			                         <p><a href="#" class="btn btn-success">即睇</a></p>
			                        
			                    </div><!-- end span -->
								
								<div class="span4 box">
									<a href="buddy.php" class="hoverBorder">
										<img src="images/buddy.png" alt="">
										
									</a>
			                        <h3 class="m_title">學習伙伴</h3>
			                        <p><a href="buddy.php" class="btn btn-success">探下佢</a></p>
