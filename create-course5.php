					...
					<div class="row">
						...
						<div class="span9">
							...
							<ul class="course-step-list">
								<li><a href="create-course1.php">Step 1：Planning &raquo; </a></li>
								...
								<li><a href="create-course5.php"id="active">Step 5：Confirm</a></li>
							</ul>
							<hr/>
								<div id="inner-container">
									...
									<p><a href="#" class="btn btn-warning">Terms and Conditions</a></p>

									<ol >
										<li><a href="#">Video Right</a></li>
										<li><a href="#">Broadcasting Schedule</a></li>

									</ol>
										-->
									<h5 class="page-title">Payment Terms</h5>


									<h4>The procedures: </h4>
									<ol>
										<li>Our Ed-novators Academic team will view your uploaded video and supporting materials and ensure the quality meets our requirements.  The process takes about 14 to 30 days</li>
									<li>Assessment criteria:</li>
									<ul>
										<li>Achieving the teaching and learning objective(s)</li>
										<li>Quality of teaching and study mission(s)</li>
										<li>Presentation techniques – funniness, use of audio-visual and interactive tools</li>
									</ul>
										<li>All qualified video will be reviewed by the management of Learn2Win to further select appropriate video.  Schedule to be broadcast will be notified the related ed-novator. </li>
										<li>Once your video is scheduled to be broadcasted, you will receive your payment within 30 days from the day of the first broadcast. </li>
										<li>All ed-novators with broadcasting video, will join our monthly “Best video award” and be entitled to our royalty payment scheme. </li>
									</ol>

									<h4>Challenge broadcasting videos: </h4>
									<ul>
										<li>Ed-novators with broadcasting video, will get a password to see all the broadcasting video in our platform.</li>
										<li>It is Learn2Win’s DNA to make learning more creative and interesting.  You can “challenge” any current broadcasting video and try to make a better one if you are confident in teaching that specific topic. </li>
										<li>Your re-produced teaching video will be reviewed by our academic and management team.  Replacement for broadcasting will be carried on when the teams agree with the quality of the production you submitted. </li>
										<li>Once your challenging video is broadcasted, you’ll receive the payment within 30 days.</li>
										<li>Ed-novators with broadcasting video(s) will be entitled to the royalty payment, please see below.</li>
									</ul>
									<h4>Royalty payment scheme:</h4>
									<ul>
										<li>Learn2Win will offer a “royalty fee” for the ed-novator whose video achieved more than 5,000 day-views on unique visitors.</li>
										<li>He/she will usually paid twice a year.  Details will be announced in due course. </li>
									</li>
									<hr/>
									<a href="payment-table.php?iframe=true&amp;width=800&amp;height=450" data-rel="prettyPhoto" class="btn btn-info">Payment Table</a>
									<!--<h4>Video For a Day</h4>
										...
										<label class="checkbox">
										    <input type="checkbox"> I understand and agree with learn2Win’s core value and your format of learning.  I would like to support them and become an educator. 
										</label>-->
								      <a href="create-course-thanks.php" class="btn btn-success">Confirm</a>
								</div>
