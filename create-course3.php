					...
					<div class="row">
						...
						<div class="span9">
							...
							<ul class="course-step-list">
								...
								<li><a href="create-course3.php" id="active">Step 3：Learning Flash Card &raquo;</a></li>
								<li><a href="create-course4.php">Step 4：Study Mission &raquo;</a></li>
								<li><a href="create-course5.php">Step 5：Confirm</a></li>
							</ul>
							<hr/>
								<div id="inner-container">
								<h5><?php if(isset($_SESSION['class-title'])){echo "You are Creating the Topic : ".$_SESSION['class-title'];} ?></h5>
									<h5 class="page-title">Create Learning Flash Card</h5>
									

									<p>Create Your Learning Flash Card：</p>

										<?php

										if(isset($_POST['flash_card_title1'],$_POST['flash_card_des1'])){
											
											if(empty($errors)){

												$card_title1         	= $_POST['flash_card_title1'];
												$card_des1				= $_POST['flash_card_des1'];
												$card_title2         	= $_POST['flash_card_title2'];
												$card_des2				= $_POST['flash_card_des2'];
												$card_title3         	= $_POST['flash_card_title3'];
												$card_des3				= $_POST['flash_card_des3'];
												$card_title4         	= $_POST['flash_card_title4'];
												$card_des4				= $_POST['flash_card_des4'];
												$card_title5         	= $_POST['flash_card_title5'];

												$card_des5				= $_POST['flash_card_des5'];
												
											    Insert_class_content_flash_card($card_title1,$card_des1,$card_title2,$card_des2,$card_title3,$card_des3,$card_title4,$card_des4,$card_title5,$card_des5);
											}
										}
									?>
								      	<form name ="flash-card"  action="" method="POST">

								      		<h5>Learning Flash Card</h5>
								      		<ol>
								      			<li>
								      				<input type="text" name = "flash_card_title1" value="" placeholder="Title">
								      				<input type="text" name = "flash_card_des1" value="" placeholder="Description">
								      			</li>
								      			<li>
								      				<input type="text" name = "flash_card_title2" value="" placeholder="Title">
								      				<input type="text" name = "flash_card_des2" value="" placeholder="Description">
								      			</li>
								      			<li>
								      				<input type="text" name = "flash_card_title3" value="" placeholder="Title">
								      				<input type="text" name = "flash_card_des3" value="" placeholder="Description">
								      			</li>
								      			<li>
								      				<input type="text" name = "flash_card_title4" value="" placeholder="Title">
								      				<input type="text" name = "flash_card_des4" value="" placeholder="Description">
								      			</li>
								      			<li>
								      				<input type="text" name = "flash_card_title5" value="" placeholder="Title">
								      				<input type="text" name = "flash_card_des5" value="" placeholder="Description">
								      			</li>

								      		</ol>
								      		<p>
								      			<a href="#flashcard" data-rel="prettyPhoto[login_panel]" class="btn btn-danger">GuideLine in Creating a Flash Card</a>
								      			<!--<a href="create-course4.php" class="btn btn-warning">Next</a>-->
								      			<input type="submit" value="next" class="btn btn-warning">
								      			<?php include('flashcard.php');?>
