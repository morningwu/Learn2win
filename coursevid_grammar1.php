				...
				<div class="row">
					...
					<div class="span6">
						<div class="header-titles">
							<h2>「系統教學」(2)</h2>
							<h4>Present Continuous Tense and Present Perfect Tense</h4>
						</div>
					</div>
				</div><!-- end row -->
			</div>
		...
		<section id="content">
			<div class="container">
				...
				<div id="mainbody">
					...
					<div class="row">
						<div class="span9">
							<h1 class="page-title">「系統教學」課程影片:Present Continuous Tense and Present Perfect Tense</h1>
							<iframe width="90%" height="600%" src="http://www.youtube.com/embed/EHARoD1remo?rel=0" frameborder="0" allowfullscreen></iframe>
						...
						<div class="span3">
							<div id="sidebar" class="sidebar-right">
								...
								<div class="widget">
									<h4 class="title">其他課程</h4>
									<ul class="menu">
										<li><a href="coursevid_grammar.php">課程一 : Present Tense</a></li>
										<li><a href="coursevid_grammar1.php">課程二 : Present Continuous Tense</a></li>
										<li><a href="coursevid_grammar2.php">課程三 : Conditionals</a></li>
										<li><a href="coursevid_grammar3.php">課程四 : Word Order - Sentence Structure</a></li>
										<li><a href="coursevid_grammar4.php">課程五 : Modal Word：can,could,may,might</a></li>
										<li><a href="coursevid_grammar5.php">課程六 : SO & NEITHER</a></li>		
										<li><a href="coursevid_grammar6.php">課程七 : Wish and Hope</a></li>	
										<li><a href="coursevid_grammar7.php">課程八 : Commonly Confused Words in English</a></li>	
										<li><a href="coursevid_grammar8.php">課程九 : Idioms in English 	</a></li>	
										<li><a href="coursevid_grammar9.php">課程十 : English Writing - Sequencing  </a></li>	
										<li><a href="coursevid_grammar10.php">課程十一 : Must and Have to  </a></li>		
