                	...
                	<div class="static-content simple">
						...
						<div class="row">
							<div class="span12">
                                ...
                                <a href="#" class="btn btn-large btn-flat">BUY ME</a><span class="line"></span>
							</div>
						</div><!-- end row -->
		...
		<section id="content">
			...
			<div class="container">
					...
					<div class="span7">
						...
						<div class="tabbable tabs_style1">
							<ul class="nav fixclear">
								<li class="active"><a href="#tabs1-pane1" data-toggle="tab">Some Tab #1</a></li>
								<li><a href="#tabs1-pane2" data-toggle="tab">Some Tab #2</a></li>
								<li><a href="#tabs1-pane3" data-toggle="tab">Some Tab #3</a></li>
							</ul>
				...
				<div class="row">
					<div class="span12">
						<div class="infobox2">
							<a href="#" class="btn btn-large btn-inverse">BUY THIS TEMPLATE</a>
							<h3 class="m_title">KALLYAS Template IS AN ALL IN ONE PRODUCT WITH LOTS OF GOODIES AND FEATURES</h3>
							<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium</p>
						</div>
					</div>
				...
				<div class="row feature_box default_style">
					...
					<div class="span3">
						...
						<p><em>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur.. <a href="#">continue reading</a></em></p>
					</div>
					<div class="span3">
						<div class="box">
				...
				<div class="row">
					...
					<div class="span4">
						<div class=" latest_posts style3">
							...
							<ul class="posts">
								<li class="post">
									<a href="#" class="hoverBorder pull-left"><img src="images/post-thumb1.jpg" alt="" /></a>
									<h4 class="title">Sed ut perspiciatis unde omnis</h4>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="span4">
						<a href="#" class="hover-box centered fixclear">
							<h3>WE'RE HIRING!</h3>
					...
					<div class="span12">
						<div class="screenshot-box fixclear">
							...
							<div class="left-side">
								...
								<a href="#" class="btn btn-large btn-flat redbtn">BUY THIS TEMPLATE ~ 15$</a>
							</div>
						...
						<div class="vertical_tabs">
							<div class="tabbable">
								<ul class="nav fixclear">
									...
									<li>
										<a href="#tabs_i2-pane3" data-toggle="tab">
										<span><span class="icon-tint icon-white"></span></span>
										UNLIMITED COLORS</a>
									</li>
									<li>
										<a href="#tabs_i2-pane4" data-toggle="tab">
										<span><span class="icon-align-left icon-white"></span></span>
										CUSTOM SHORTCODES</a>
									</li>
									<li>
										<a href="#tabs_i2-pane5" data-toggle="tab">
